                    ...
                    <div class="flex flex-row max-w-[1366px] w-full h-full">
                        ...
                        <div class="flex flex-col items-center justify-start gap-5 w-full h-full remove-scroll overflow-y-scroll">
                            ...
                            <form v-if="currentUser.get('AccountType') === 'Student'" class="flex flex-col items-start justify-start gap-3 max-[35%] w-[35%] h-auto py-[30px]">
                                ...
                                <select class="bg-black/20 border-[1px] border-gray p-[10px] w-full text-white text-[13px]">
                                    <option class="text-black text-[13px]">{{UserData.StudentDegreeIDPointer}}</option>
                                </select>
                                <!--add new course-->
                                <span class="text-white text-[13px]">SELECT COURSE</span>
                                <div class="flex flex-col border-[1px] border-gray bg-black/20 px-[10px] h-[200px] w-full remove-scroll overflow-y-scroll cursor-default">
                                    <div class="flex items-center gap-1 py-[5px]"><input class="cursor-pointer" type="checkbox" id="course" /><label class="text-white text-[13px] cursor-pointer" for="course">Course Name</label></div>
                                </div>
                                <div class="flex justify-end w-full"><button class="bg-blue text-white text-[12px] py-[5px] w-[80px]">ADD</button></div>
                                <!--student's current course (remove current course)-->
                                <span class="text-white text-[13px]">CURRENT COURSE</span>
                                <div class="flex flex-col border-[1px] border-gray bg-black/20 px-[10px] h-[200px] w-full remove-scroll overflow-y-scroll cursor-default">
                                    <div class="flex items-center gap-1 py-[5px]"><input class="cursor-pointer" type="checkbox" id="course" /><label class="text-white text-[13px] cursor-pointer" for="course">Course Name</label></div>
                                </div>
                                <div class="flex justify-end w-full"><button class="bg-blue text-white text-[12px] py-[5px] w-[80px]">REMOVE</button></div>
                                <!--save changes button-->
                                <div class="flex flex-row justify-center w-full">
                                    <button @click="saveChanges()" class="bg-blue text-white text-[12px] py-[10px] w-full">SAVE CHANGES</button>
                                </div>
                            ...
                            <form v-if="currentUser.get('AccountType') === 'Teacher'" class="flex flex-col items-start justify-start gap-3 max-[35%] w-[35%] h-auto py-[30px]">
                                ...
                                <!--save changes button-->
                                <div class="flex flex-row justify-center w-full">
                                    <button class="bg-blue text-white text-[12px] py-[10px] w-full">SAVE CHANGES</button>
                                </div>
